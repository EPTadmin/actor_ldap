...
var course_indecol = course.filter(x => x.group ==="i").filter(x => x.type != 'MS').filter(x => x.type != 'FP')
...
var lineChartData_indecol = {
  labels: course.filter(x => x.group ==="i").filter(x => x.type != 'MS').filter(x => x.type != 'FP'),

    datasets: []
}
// var lineChartData_indecol2 = {
//   labels: course.filter(x => x.group ==="i").filter(x => x.type != 'MS').filter(x => x.type != 'FP'),
...
for (let a=0; a<lineChartData_indecol.datasets.map(x=>x.label).length;a++){
  data_set.push({label : lineChartData_indecol.datasets.map(x=>x.label)[a],data : lineChartData_indecol.datasets.map(x=>x.data)[a],backgroundColor : color[a],footer : lineChartData_indecol.datasets.map(x=>x.footer)[a]})
...
if (type !== 'All' & type !== 'H' & type !== 'V'){
  ...
  var course_indecol = course.filter(x => x.group ==="i").filter(x => x.type === type).filter(x => x.type != 'MS').filter(x => x.type != 'FP')
  var course_indecol_id = course_indecol.map(x => x.id)
  ...
  var lineChartData_indecol = {
    labels: course.filter(x => x.group ==="i").filter(x => x.type === type).filter(x => x.type != 'MS').filter(x => x.type != 'FP'),
  ...
  console.log('lineChart',lineChartData_indecol)
  
  
  var data_set=[]
  
  for (let a=0; a<lineChartData_indecol.datasets.map(x=>x.label).length;a++){
      data_set.push({label : lineChartData_indecol.datasets.map(x=>x.label)[a],data : lineChartData_indecol.datasets.map(x=>x.data)[a],backgroundColor : color[a],footer : lineChartData_indecol.datasets.map(x=>x.data)[a]})
    }
  ...
  var data ={
        ...
        var course_indecol = course.filter(x => x.group ==="i").filter(x => x.semester === type).filter(x => x.type != 'MS').filter(x => x.type != 'FP')
        var course_indecol_id = course_indecol.map(x => x.id)
        ...
        var lineChartData_indecol = {
          labels: course.filter(x => x.group ==="i").filter(x => x.semester === type).filter(x => x.type != 'MS').filter(x => x.type != 'FP'),
